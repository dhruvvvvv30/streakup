...
class _CreateProfileScreenState extends State<CreateProfileScreen> {
  ...
  final List<String> _maleAvatars = List.generate(
    6,
    (i) => 'assets/avatars/M${i + 1}.png',
  );
  final List<String> _femaleAvatars = List.generate(
    6,
    (i) => 'assets/avatars/F${i + 1}.png',
  );
    ...
    if (_currentPage > 0) {
      ...
      final confirm = await showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text(
            "You'll need to log in again to continue setting up your profile.",
          ),
          actions: [
            TextButton(
  ...
  Future<void> _completeProfile() async {
    ...
    debugPrint(
      '🔵 [Profile] session: ${Supabase.instance.client.auth.currentSession}',
    );
    ...
    try {
      ...
      await Supabase.instance.client
          ...
          .timeout(
            ...
            onTimeout: () => throw Exception(
              'Upsert timed out after 10s — likely network or RLS issue',
            ),
          );
      ...
      debugPrint(
        '🔴 [Profile] PostgrestException: ${e.message} | code: ${e.code} | details: ${e.details}',
      );
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        Text(
                          "Let's build your StreakUp identity",
      ...
      children: [
        ...
        Text(
          ...
          style: AppText.body(
            ...
            color: isActive ? AppColors.purple : AppColors.sub,
          ),
        ),
      ],
    );
  ...
  Widget _buildStep2GenderAvatar() {
    List<String> currentAvatars = _gender == 'male'
        ? _maleAvatars
        : _femaleAvatars;
    return SingleChildScrollView(
      padding: const EdgeInsets.symmetric(horizontal: 24),
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'This helps us show you avatars that suit you!',
            style: AppText.body(size: 14),
          ),
          const SizedBox(height: 24),
          Row(
          ...
          children: [
            ...
            Text(
              ...
              style: AppText.body(
                size: 16,
                weight: FontWeight.w800,
                color: isSelected ? color : AppColors.sub,
              ),
            ),
          ],
        ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'These are optional, but help us know you better!',
            style: AppText.body(size: 14),
          ),
          const SizedBox(height: 32),
          _buildTextAreaBox(
            ...
            hint:
                'E.g. I love fitness, enjoy late night walks and building cool things.',
            maxLength: 200,
          ...
          _buildTextAreaBox(
            ...
            hint:
                'E.g. Build a consistent workout streak, stay healthy, run a marathon.',
            maxLength: 150,
          ...
          _buildTextAreaBox(
            ...
            hint:
                'E.g. To become the best version of myself and inspire others.',
            maxLength: 150,
            controller: _motivationController,
          ),
          const SizedBox(height: 24),
          _buildTipCard(
            'You can update or add to these later in your profile settings.',
          ),
        ],
      ),
    );
